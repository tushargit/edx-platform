;(function (define, undefined) {
    ...
    define([
        ...
        FieldViews.FieldView = Backbone.View.extend({
            ...
            indicators: {
                'canEdit': '<span class="icon fa fa-pencil message-can-edit" aria-hidden="true"> +' +
                    '</span><span class="sr">' +
                ...
                'success': '<span class="fa fa-check message-success" aria-hidden="true"></span>' +
                    '<span class="sr">' +
                    gettext("Success") + '</span>',
                'plus': '<span class="fa fa-plus placeholder" aria-hidden="true"></span>' +
                    '<span class="sr">' +
