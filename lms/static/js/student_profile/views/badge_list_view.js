            ...
            var BadgeListView = ListView.extend({
                ...
                renderCollection: function() {
                    ...
                    this.collection.each(function(badge, index) {
                        if (index % 2 === 0) {
                            $row = HtmlUtils.append(this.$el, HtmlUtils.HTML('<div class="row">'));
                        }
                        item = new BadgeView({
                            model: badge,
                    ...
                    if (!this.collection.hasNextPage()) {
                        ...
                        placeholder = this.template({find_courses_url: self.find_courses_url});
                        if (this.collection.length % 2 === 0) {
                            $row = HtmlUtils.append(this.$el, HtmlUtils.HTML('<div class="row">'));
                        }
                        HtmlUtils.append($row, placeholder);
                    }
                    return this;
                }
            });
