...
class CourseTopicsView(DeveloperErrorViewMixin, APIView):
    ...
    **Example Requests**:
        ...
        GET /api/discussion/v1/course_topics/course-v1:ExampleX+Subject101+2015
            ?topic_id=a29d117faf43c7c59eda7717e722e9d8f4a47ea8

    **Response Values**:
        if topic_id is not given:
        ...
        if topic_id is given:
            * id: The id of the discussion topic.
    ...
    def get(self, request, course_id):
        ...
        if not topic_id:
            ...
            response = get_course_topic(request, course_key, topic_id)
